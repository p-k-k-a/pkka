...
export function EventsArchiveBand({ variant = "public" }: { variant?: EventPathVariant }) {
  return (
    <section className="bg-band text-band-foreground px-4 py-16 md:px-10 md:py-20">
      <div className="mx-auto max-w-[1280px] space-y-6">
        <p className="bg-accent/20 text-band-foreground inline-flex rounded-lg px-3 py-1 text-xs font-semibold tracking-widest uppercase">
          Archiwum
        </p>
        ...
        <p className="text-band-foreground/80 max-w-2xl text-base leading-relaxed">
